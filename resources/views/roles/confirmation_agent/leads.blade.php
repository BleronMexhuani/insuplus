                        ...
                        <div class="swiper-slide">
                            <div class="row">
                                ...
                                ">
                                    ...
                                    <span style="font-size: 14px">{{Carbon\Carbon::parse($item->termindatum)->format('d-m-Y')}}</span>
                                ...
                                color: black;
                                font-size: 18px;
                                font-family: Poppins;">{{$item->count}} Terminiert</span>
                                ...
                                <div class="col">
                                    <div style="    display: flex;justify-content: flex-end; flex-direction: row;">
                                        <span
                                            ...
                                            font-weight: 600;
                                            color: white;
                                            font-size: 22px;">2023</span>
                                        <svg width="100px" height="95" viewBox="0 0 63 59" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M63 0H0C5.00001 39 13.5 62 63 58V0Z" fill="#00727A" />
                                        </svg>
                                    </div>
                                </div>
                            </div>
