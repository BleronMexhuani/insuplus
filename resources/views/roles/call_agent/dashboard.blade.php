    ...
    <div class="col ms-0 ms-md-2 px-0 px-md-2 pe-md-4" style="margin-top:16px !important;">
                        ...
                        <div class="mt-5 apexchart">
                            <div class="row">
                                ...
                                <div class="col-8 d-flex justify-content-end">
                                    ...
                                    <div class="mt-3 ms-4">
                                        <button onclick="chartlista()" type="button" class="btn btnleads">Filter</button>
                                    </div>
                                </div>
        ...
        <script>
            ...
            Highcharts.setOptions({
                colors: ['#29E7CD', '#F97035', '#F9CE35', '#21618C', '#17202A']
            });
            ...
            async function chartlista() {
                ...
                let i = 0;
                let colors = ['#29E7CD', '#F97035', '#F9CE35', '#21618C', '#17202A']
                const series_data = [];
                const response = await axios.get('/chart?from=' + from + '&to=' + to);
