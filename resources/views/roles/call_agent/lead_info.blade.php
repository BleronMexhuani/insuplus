            ...
            <div class="bgform mt-4 p-4 p-md-5">
                <div class="row">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <div class="mt-2">
                            <input class="inputform" value="{{ $lead->vorname }}" type="text" name="vorname" placeholder="Jane" />
                        </div>
                        <div class="mt-4">
                            <span class="subtitleform">Anrede</span>
                        </div>
                        <div class="mt-2">
                            <input class="inputform" type="number" value="{{ $lead->anrede }}" id="tentacles" name="anrede" placeholder="Herr" min="1" max="9" />
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="">
                        ...
                        <div class="mt-2">
                            <input class="inputform" value="{{ $lead->nachname }}" type="text" name="nachname" placeholder="Jane" />
                        </div>
                        <div class="mt-4">
                            <span class="subtitleform">Geburtsdatum </span>
                        </div>
                        <div class="mt-2">
                            <input class="inputform" value="{{ $lead->geburtsdatum }}" type="date" id="birthday" name="geburtsdatum" />
                        </div>
                    </div>
                </div>
                <hr>
                    ...
                    <div class="col-12 col-md-4 mt-2">
                        ...
                        <div class="mt-2 ">
                            <div class="d-flex mb-3 ">
                                <input type="text" value="{{ $lead->adresse }}" name="adresse" class="inputgroupleft" placeholder="James Scar" aria-label="Username">
                                <input type="text" value="{{ $lead->hause_nummer }}" name="hause_nummer" class="inputgroupright" placeholder="Haus Nummer" aria-label="Haus Nummer">
                            </div>
                        </div>
                        <div class="mt-4 ">
                        ...
                        <div class="mt-2">
                            <input class="inputform" value="{{ $lead->kanton }}" type="text" name="kanton" placeholder="Kanton" />
                        </div>
                    </div>
                    <div class="col-12 col-md-4 mt-2">
                        <div class="">
                        ...
                        <div class="mt-2">
                            <div class="d-flex mb-3 ">
                                <input type="text" value="{{ $lead->plz }}" name="plz" class="inputgroupleft" placeholder="PLZ" aria-label="Username">
                                <input type="text" value="{{ $lead->stadt }}" name="stadt" class="inputgroupright" placeholder="Stadt" aria-label="stadt">
                            </div>
                        </div>
                        <div class="mt-4">
                        ...
                        <div class="mt-2 mb-4">
                            <input class="inputform" type="text" value="{{ $lead->region }}" name="region" placeholder="Lorem" />
                        </div>
                    </div>
                </div>
                <hr>
                    ...
                    <div class="col-12 col-md-4 mt-2 mb-2 mb-md-5">
                        ...
                        <div class="mt-2 ">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" value="{{ $lead->handy_nummer }}" name="handy_nummer" class="form-control inputnumber" placeholder="" aria-label="" aria-describedby="basic-addon1">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-1 tab mt-4 ms-0 ms-md-0 px-3 px-md-3 d-flex justify-content-center">
                    ...
                    <div class="col-auto">
                        <label class="tablinks" onclick="openCity(event, 'Falsche Nummer')">
                            <input type="radio" name="feedback_status" value="Falsche Nummer" style="display: none;"> Falsche Nummer
                        </label>
                    ...
                    <div class="col-auto">
                        <label class="tablinks" onclick="openCity(event, 'Hat schon gewechselt')">
                            <input type="radio" name="feedback_status" value="Hat schon gewechselt" style="display: none;"> Hat schon gewechselt
                        </label>
                    ...
                    <div class="col-auto">
                        <label class="tablinks" onclick="openCity(event, 'Kein Interesse')">
                            <input type="radio" name="feedback_status" value="Kein Interesse" style="display: none;"> Kein Interesse
                        </label>
                    ...
                    <div class="col-auto">
                        <label class="tablinks" onclick="openCity(event, 'Kunde bereits terminiert')">
                            <input type="radio" name="feedback_status" value="Kunde bereits terminiert" style="display: none;">Kunde bereits terminiert
                        </label>
                    ...
                    <div class="col-auto">
                        <label class="tablinks" onclick="openCity(event, 'Nicht Brauchbar')">
                            <input type="radio" name="feedback_status" value="Nicht Brauchbar" style="display: none;">Nicht Brauchbar
                        </label>
                    ...
                    <div class="col-auto">
                        <label class="tablinks" onclick="openCity(event, 'Nicht Erreicht')">
                            <input type="radio" name="feedback" value="Nicht Erreicht" style="display: none;">Nicht Erreicht
                        </label>
                    ...
                    <div class="col-auto">
                        <label class="tablinks" onclick="openCity(event, 'Online-Offerte')">
                            <input type="radio" name="feedback_status" value="Online-Offerte" style="display: none;">Online-Offerte
                        </label>
                    ...
                    <div class="col-auto">
                        <label class="tablinks" onclick="openCity(event, 'Später Anrufrn')">
                            <input type="radio" name="feedback_status" value="Später Anrufrn" style="display: none;">Später Anrufrn
                        </label>
                    ...
                    <div class="col-auto">
                        <label class="tablinks" onclick="openCity(event, 'Terminiert')">
                            <input type="radio" name="feedback_status" value="Terminiert" style="display: none;">Terminiert
                        </label>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col mb-3">
                                ...
                                <div class="mt-2">
                                    <input class="inputform" type="number" name="zeitfuranrufen" placeholder="09:00" />
                                </div>
                            </div>
                        </div>
                    </div>
