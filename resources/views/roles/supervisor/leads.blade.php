                    ...
                    <div class="panel">
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group mt-2">
                                    <input type="text" class="form-controol input-sm" placeholder="von"
                                        ...
                                        name="created_at[]" onchange="change()">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group mt-2 ">
                                    <select class="selectpicker" data-live-search="true" multiple data-actions-box="true" name="assgined_from">
                                        @foreach ($umfrage_agents as $item)
                                        <option value="{{$item->id}}">{{$item->name}}</option>
                                        @endforeach
                                    </select>
                                    <select class="selectpicker" data-live-search="true" multiple data-actions-box="true" name="assign_to_id_call">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="mt-2">
                                    <select class="selectpicker" data-live-search="true" multiple data-actions-box="true" name="teams[]">
