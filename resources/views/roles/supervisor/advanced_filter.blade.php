@extends('layouts.app')
@section('content')
<form class="needs-validation" action="{{ route('searchLeads') }}" method="GET"  onkeydown="return event.key != 'Enter';" enctype="multipart/form-data" novalidate>
    @csrf
                ...
                <div class="col-4 mt-2 mb-5">
                    ...
                    <div class="mt-2 ">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control inputnumber" placeholder="" name="handy_nummer[]" aria-label="" aria-describedby="basic-addon1">
                        </div>
                    </div>
                </div>
                <div class="col-4 mt-2 mb-5 ">
