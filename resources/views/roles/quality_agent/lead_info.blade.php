                        ...
                        <div class="mt-5">
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    ...
                                    <script>
                                        $("#koment_der_Konnen").val('{{ isset($last_feedback->person_krank) ? $last_feedback->person_krank : '' }}')
                                            .change();
                                    </script>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            <div class="mt-2 ms-2" id="bestatigungs_status" style="display: none">
                                ...
                                <script>
                                    $("#besta").val('{{ isset($last_feedback->bestatigungsstatus) ? $last_feedback->bestatigungsstatus : '' }}')
                                        .change();
                                </script>
                            </div>
                        </div>
